...
/**
 * \file    test/phpunit/MyDATAFunctionalTest.php
 * \ingroup mydata
 ...
 * @package Testmydata
 */
class MyDATAFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/mydata/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mydata/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mydata/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mydata/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mydatawidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMyDATA_MyDATATriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMyDATA_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
